...
namespace SyntBotsDesktopImplementation.RPAScripts
{
    ...
    public partial class SyntBotsAdapter : BaseScripts
    {
        ...
        public override void AutomateScript()
        {
            ...
            //Modified by Velan 19/01/2022 for Flint and Lapeer Golive
            ...
            string CentralcodingPassReason = _configuration.AppSettings.Settings["CentralCodingPassReason"] != null ? _configuration.AppSettings.Settings["CentralCodingPassReason"].Value : string.Empty;
            string OaklandCodingPassReason = _configuration.AppSettings.Settings["OaklandCodingPassReason"] != null ? _configuration.AppSettings.Settings["OaklandCodingPassReason"].Value : string.Empty;
            string LansingCodingPassReason = _configuration.AppSettings.Settings["LansingCodingPassReason"] != null ? _configuration.AppSettings.Settings["LansingCodingPassReason"].Value : string.Empty;
            string BayCodingPassReason = _configuration.AppSettings.Settings["BayCodingPassReason"] != null ? _configuration.AppSettings.Settings["BayCodingPassReason"].Value : string.Empty;

            //For Macomb
            string MacombCodingPassReason = _configuration.AppSettings.Settings["MacombCodingPassReason"] != null ? _configuration.AppSettings.Settings["MacombCodingPassReason"].Value : string.Empty;


            //Added by Velan on 19-01-2022, for Flint and Lapeer Go Live
            string FlintCodingPassReason = _configuration.AppSettings.Settings["FlintCodingPassReason"] != null ? _configuration.AppSettings.Settings["FlintCodingPassReason"].Value : string.Empty;
            string LapeerCodingPassReason = _configuration.AppSettings.Settings["LapeerCodingPassReason"] != null ? _configuration.AppSettings.Settings["LapeerCodingPassReason"].Value : string.Empty;

            //Added by Velan on 19-05-2022 , for Northern Michigan Go Live
            string NorthernMichiganPassReason = _configuration.AppSettings.Settings["NorthernMichiganPassReason"] != null ? _configuration.AppSettings.Settings["NorthernMichiganPassReason"].Value : string.Empty;
            ...
            try
            {
                ...
                if (toBeProcessedfiles.Count() > 0)
                {
                    ...
                    //Modified by Velan 19/01/2022 , for Flint and Lapeer Go Live
                    ...
                    try
                    {
                        ...
                        foreach (ListViewRow row in abc[0].Rows)
                        {
                            ...
                            {
                                Atos.SyntBots.Common.Logger.Log("before apply Pending or OnHold filters", LogFilePath);
                                ...
                                Atos.SyntBots.Common.Logger.Log("After apply pending filters 1 ", LogFilePath);
                                pattern.Select();
                                Atos.SyntBots.Common.Logger.Log("After apply pending filters 2", LogFilePath);

                                row.KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.SPACE);
                                Atos.SyntBots.Common.Logger.Log("After apply pending filters 3", LogFilePath);
                            }
                        }
                        Thread.Sleep(500);
                        ...
                        foreach (ListViewRow row in abc[1].Rows)
                        {
                            ...
                            {
                                Atos.SyntBots.Common.Logger.Log("before apply Coding OP - LAB filters", LogFilePath);
                                SelectionItemPattern pattern = (SelectionItemPattern)(BasePattern)row.AutomationElement.GetCurrentPattern(SelectionItemPattern.Pattern);
                                Atos.SyntBots.Common.Logger.Log("After apply Coding OP - LAB filters 1", LogFilePath);
                                pattern.Select();
                                Atos.SyntBots.Common.Logger.Log("After apply Coding OP - LAB filters 2", LogFilePath);
                                row.KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.SPACE);
                                Atos.SyntBots.Common.Logger.Log("After apply Coding OP - LAB filters 3", LogFilePath);
                                break;
                            }
                        }
                        System.Threading.Thread.Sleep(500);
                    ...
                    foreach (var Encounter in FINlist)
                    {
                        ...
                        try
                        {
                            ...
                            if (Encounter.Organization.ToLower().Contains("lansing"))
                            {
                                facility = "Lansing";
                                codingPassReason = LansingCodingPassReason;
                            }
                            else if (Encounter.Organization.ToLower().Contains("central"))
                            {
                                facility = "Central";
                                codingPassReason = CentralcodingPassReason;
                            }
                            else if (Encounter.Organization.ToLower().Contains("oakland"))
                            {
                                facility = "Oakland";
                                codingPassReason = OaklandCodingPassReason;
                            }
                            else if (Encounter.Organization.ToLower().Contains("bay"))
                            {
                                facility = "Bay";
                                codingPassReason = BayCodingPassReason;
                            }
                            else if (Encounter.Organization.ToLower().Contains("macomb"))
                            {
                                facility = "Macomb";
                                codingPassReason = MacombCodingPassReason;
                            }
                            //Added by Velan on 19-01-2022 , for Northern Michigan Go Live
                            else if (Encounter.Organization.ToLower().Contains("flint"))
                            {
                                facility = "Flint";
                                codingPassReason = FlintCodingPassReason;
                            }
                            else if (Encounter.Organization.ToLower().Contains("lapeer"))
                            {
                                facility = "Lapeer";
                                codingPassReason = LapeerCodingPassReason;
                            }
                            //Added by Velan on 19-05-2022 , for Flint and Lapeer Go Live
                            else if (Encounter.Organization.ToLower().Contains("northern michigan"))
                            {
                                facility = "northern michigan";
                                codingPassReason = NorthernMichiganPassReason;
                            }
                            ...
                            catch (Exception ex)
                            {
                                ...
                                //        Atos.SyntBots.Common.Logger.Log("Check1 " + chargeList.Count, LogFilePath);
                                ...
                                //        Thread.Sleep(1000);
                                //        Atos.SyntBots.Common.Logger.Log("Check2 " + chargeList.Count, LogFilePath);
                                //        TreeWalker tWalker = TreeWalker.ControlViewWalker;
                                //        Thread.Sleep(2000);
                                //        Atos.SyntBots.Common.Logger.Log("Check3 " + chargeList.Count, LogFilePath);
                                //        AutomationElement fin = null;
                                //        try
                                //        {
                                //            fin = _grid[0].GetElement(SearchCriteria.ByText(FIN));
                                //        }
                                //        catch(Exception e)
                                //        {
                                //            Thread.Sleep(2000);
                                ...
                                //        }
                                //        Thread.Sleep(2000);
                                //        Atos.SyntBots.Common.Logger.Log("Check4 " + chargeList.Count, LogFilePath);
                                //        AutomationElement Row;
                                //        try
                                //        {
                                //             Row = tWalker.GetParent(fin);
                                //        }
                                //        catch(Exception e)
                                //        {
                                //            Thread.Sleep(2000);
                                //             Row = tWalker.GetParent(fin);
                                //        }
                                //        Atos.SyntBots.Common.Logger.Log("Check5 " + chargeList.Count, LogFilePath);
                                //        SelectionItemPattern pattern1 = (SelectionItemPattern)(BasePattern)Row.GetCurrentPattern(SelectionItemPattern.Pattern);
                                //        //Thread.Sleep(1000);
                                //        Atos.SyntBots.Common.Logger.Log("Check6 " + chargeList.Count, LogFilePath);
                                //        pattern1.Select();
                                //        Atos.SyntBots.Common.Logger.Log("Check7 " + chargeList.Count, LogFilePath);

                                //        _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.DOWN);
                                //        Atos.SyntBots.Common.Logger.Log("Check8 " + chargeList.Count, LogFilePath);
                                //        _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.UP);
                                //        Atos.SyntBots.Common.Logger.Log("Check9 " + chargeList.Count, LogFilePath);
                                ...
                                //        AutomationElement aePassReasonTxt = driver.GetElmtByWlker(aePassReasonDialog, null, "1001", null, null, null, -1, 15);
                                //        //aePassReasonTxt.
                                //        //driver.AESetText(aePassReasonTxt, "Coding - Suspended Charges");


                                //        driver.AEClick(aePassReasonTxt);
                                //        Keyboard.Instance.Enter("Coding - Suspended Charges");
                                ...
                                if (ex.Message.Contains("Suspended Charge"))
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        driver.AEClick(Btn);
                                        AutomationElement aePassReasonDialog = driver.GetElmtByWlker(_accessHIMWindow.AutomationElement, "Pass on Task", null, null, "dialog", null, -1, 15);
                                        if (aePassReasonDialog == null)
                                        {
                                            Atos.SyntBots.Common.Logger.Log("Text control has not been initialized", LogFilePath);
                                        }
                                        else
                                        {
                                            Atos.SyntBots.Common.Logger.Log("Text control has  been initialized", LogFilePath);
                                        }
                                        AutomationElement aePassReasonTxt = driver.GetElmtByWlker(aePassReasonDialog, null, "1001", null, null, null, -1, 15);
                                        ...
                                        {
                                            Atos.SyntBots.Common.Logger.Log("Error on enter pass reason Text. Error : " + ex.Message, LogFilePath);
                                        }
                            ...
                            if (listPowerChartOrders.Count() == 0 && chargeList.Count() == 0)
                            {
                                ...
                                //    AutomationElement fin = _grid[0].GetElement(SearchCriteria.ByText(FIN));
                                //    Thread.Sleep(1000);
                                //    Atos.SyntBots.Common.Logger.Log("686", LogFilePath);
                                //    AutomationElement Row = tWalker.GetParent(fin);
                                //    Atos.SyntBots.Common.Logger.Log("688", LogFilePath);
                                //    SelectionItemPattern pattern1 = (SelectionItemPattern)(BasePattern)Row.GetCurrentPattern(SelectionItemPattern.Pattern);
                                //    Atos.SyntBots.Common.Logger.Log("690", LogFilePath);
                                //    pattern1.Select();
                                //    _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.DOWN);
                                //    _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.UP);
                                ...
                                if (!debugMode)
                                {
                                    if (!shouldDNBeRaised)
                                    {
                                        ...
                                        //    driver.AEClick(aePassReasonTxt);
                                        //    Keyboard.Instance.Enter("Coding - Action BOT Hold");
                            ...
                            if (!isZeroCharges)
                            {
                                ...
                                //Code to compare charge 81001 with both 81003 and 81015 orders as 81001 holds both Micro and Macro charges
                                ...
                                // #Specail Case Scenario: 
                                //Code to raise missing charge 81001 when both 81003 and 81015 orders are available
                                if ((chargeList.Where(s => s.CPT4 == "81001").Count() == 0) && listPowerChartOrders.Where(s => s.CPT4 == "81003").Count() > 0 && listPowerChartOrders.Where(s => s.CPT4 == "81015").Count() > 0)
                                {
                                    listPowerChartOrders.Remove(listPowerChartOrders.Where(s => s.CPT4 == "81003").FirstOrDefault());
                                    listPowerChartOrders.Remove(listPowerChartOrders.Where(s => s.CPT4 == "81015").FirstOrDefault());
                                ...
                                //{
                                //    _accessHIMWindow = GetWindowWithWait("AccessHIM", 15);
                                //    Atos.SyntBots.Common.Logger.Log("Check19 " + chargeList.Count, LogFilePath);
                                //    var _grid = _accessHIMWindow.GetMultiple<TestStack.White.UIItems.ListView>(SearchCriteria.ByControlType(ControlType.DataGrid));
                                //    Thread.Sleep(1000);
                                //    Atos.SyntBots.Common.Logger.Log("Check20 " + chargeList.Count, LogFilePath);
                                //    TreeWalker tWalker = TreeWalker.ControlViewWalker;
                                //    Atos.SyntBots.Common.Logger.Log("Check21 " + chargeList.Count, LogFilePath);
                                //    Thread.Sleep(2000);
                                //    AutomationElement fin = null;
                                //    try
                                //    {
                                ...
                                //        Row = tWalker.GetParent(fin);
                                //    }
                                //    Atos.SyntBots.Common.Logger.Log("Check23 " + chargeList.Count, LogFilePath);

                                //    SelectionItemPattern pattern1 = (SelectionItemPattern)(BasePattern)Row.GetCurrentPattern(SelectionItemPattern.Pattern);
                                //    Atos.SyntBots.Common.Logger.Log("Check24 " + chargeList.Count, LogFilePath);

                                //    pattern1.Select();
                                //    Atos.SyntBots.Common.Logger.Log("Check25 " + chargeList.Count, LogFilePath);
                                //    _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.DOWN);
                                //    Atos.SyntBots.Common.Logger.Log("Check26 " + chargeList.Count, LogFilePath);
                                //    _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.UP);
                                //    Atos.SyntBots.Common.Logger.Log("Check27 " + chargeList.Count, LogFilePath);
                                ...
                                try
                                {
                                    ...
                                    TreeWalker tWalker = TreeWalker.ControlViewWalker;
                                    Thread.Sleep(1000);
                                    Atos.SyntBots.Common.Logger.Log("Grid Count " + _grid.Count(), LogFilePath);
                                    AutomationElement fin = _grid[0].GetElement(SearchCriteria.ByText(FIN));

                                    Atos.SyntBots.Common.Logger.Log("works until line number 875 ", LogFilePath);
                                    AutomationElement Row = null;
                                    if (fin == null)
                                    {
                                        Atos.SyntBots.Common.Logger.Log("AutomationElement fin is null", LogFilePath);
                                        throw new Exception("Error occured while selecting the FIN, The FIN is not available in the grid view or unable to find the FIN in grid ");
                                    }
                                    else
                                    {
                                        Row = tWalker.GetParent(fin);
                                    ...
                                    Atos.SyntBots.Common.Logger.Log("works until line number 877 ", LogFilePath);
                                    SelectionItemPattern pattern1 = (SelectionItemPattern)(BasePattern)Row.GetCurrentPattern(SelectionItemPattern.Pattern);
                                    Atos.SyntBots.Common.Logger.Log("works until line number 879", LogFilePath);
                                    pattern1.Select();
                                    _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.DOWN);
                                    _grid[0].KeyIn(TestStack.White.WindowsAPI.KeyboardInput.SpecialKeys.UP);
                                ...
                                if (listPowerChartOrders.Count == 0 && chargeList.Count == 0)
                                {
                                    ...
                                    if (!debugMode)
                                    {
                                        ...
                                        //    driver.AEClick(aePassReasonTxt);
                                        //    Keyboard.Instance.Enter("Coding - Action BOT Document Verified");
                            ...
                            if (appendDNComment)
                            {
                                ...
                                if (sbMissingCharges.Length > 0 && sbChargeDeletion.Length > 0 && sbChargeModification.Length == 0)
                                {
                                    ...
                                    dn = "Charge addition and deletion";
                                ...
                                if (isZeroCharges || sbMissingCharges.Length > 0 || sbChargeModification.Length > 0 || sbChargeDeletion.Length > 0)
                                {
                                    ...
                                    if (isDefaultcodeAdded && !isErrorOccurredAtDNLevel)
                                    {
                                        try
                                        {
                                            ...
                                            //toBeProcessedWSheet.Cells[i, commentsColumnIndex] = string.Format("{0} DN Raised", dnType);
                                            //toBeProcessedWSheet.Cells[i, commentsColumnIndex + 1] = dnComment;
            ...
            catch (Exception ex)
            {
                ...
                try
                {
                    ...
                    email.SendEMail(automationTeamEmail, string.Format("ALERT : {0} - Execution Failed - Bot Agent # {1}", facility, botAgentName), "Bot Execution Failed. Error: " + ex.Message + ". InnerExeception: " + ex.InnerException, "");
